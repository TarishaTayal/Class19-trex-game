...
function setup() {
  ...
  score = 0;
  gameOver2= createSprite(300,50,40,40);
  gameOver2.addImage("gameOver",gameOver1)
  gameOver2.scale=0.5
  gameOver2.visible=false;
  restart2=createSprite(300,100,40,40);
  restart2.addImage("restart",restart1)
  restart2.scale=0.5
